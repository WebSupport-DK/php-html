...
class Form
{
    public static function start($action, $method, $file_upload = false, $options = null)
    {
        if ($file_upload == true) {
...
FORM;
    ...
    public static function create($action, $method, $inputfields = array(), $options = null)
    {
        $inputs = "<input />";
...
INPUT;
    ...
    public static function submit($name = null, $value = null, $options = null)
    {
        if ($value == null) {
            $value = '';
        } else {
...
SUBMIT;
    ...
    public static function textarea($name, $options = null, $content = null)
    {
        echo <<<TEXTAREA
...
OPTIONS;
    ...
    public static function select($name, $options = null, $extra = null)
    {
        $data = '';
...
SELECT;
    ...
    public static function space($amount = 1)
    {
        for ($x = 1; $x <= $amount; $x++) {
            echo "<br>";
        } 
